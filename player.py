from Platforms import Platform, Spikes, BlockTeleport
from Animations import ANIMATION_JUMP_LEFT, ANIMATION_JUMP_RIGHT, ANIMATION_JUMP, ANIMATION_STAY, ANIMATION_LEFT, ANIMATION_RIGHT, ANIMATION_DELAY
import pygame
...
class Player(Sprite):
    def __init__(self, x: int = 0, y: int = 0):
        ...
        self.animLeft=pyganim.PygAnimation(self.createAnimation(ANIMATION_LEFT))
        self.animRight=pyganim.PygAnimation(self.createAnimation(ANIMATION_RIGHT))
